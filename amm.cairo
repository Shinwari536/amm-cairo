...
func swap{range_check_ptr}(
    ...
    tempvar a = transaction.token_a_amount # the amount user wants to give to receive teken b
    tempvar x = state.token_a_balance # balance of a in AMM currently
    tempvar y = state.token_b_balance # balance of b in AMM curretly

    # Check that balances are in range.
    ...
    # type token_a. You should use the public key returned by modify_account().
